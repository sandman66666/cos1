#!/usr/bin/env python3
"""
Split Key Opus Script
Splits opus_key.txt into 10 equally-sized files (opus_key1.txt, opus_key2.txt, etc.)
"""

import os
import math

def split_key_opus_file():
    """Split opus_key.txt into 10 equally-sized files"""
    
    input_file = 'opus_key.txt'
    num_files = 10
    ...
    for i in range(num_files):
        ...
        # Write chunk to file
        output_filename = f'opus_key{i + 1}.txt'
